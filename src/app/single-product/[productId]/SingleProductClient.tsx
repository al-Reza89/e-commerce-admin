'use client';
import InputField from '@/components/single-product-page/input-field';
import SingleProductDetails from '@/components/single-product-page/single-product-details';
...
const SingleProductClient: React.FC<SingleProductClientProps> = ({
  productDetailsById,
}) => {
  ...
  return (
    <div className="">
      <section className="pt-24 font-poppins dark:bg-gray-800">
        <div className="max-w-6xl px-4 mx-auto">
          <div className="flex flex-wrap mb-24 -mx-4">
            <div className="w-full px-4 mb-8 md:w-1/2 md:mb-0">
              <div className="sticky top-24 overflow-hidden ">
                <div className="relative mb-6 lg:mb-10 lg:h-96">
                  <div className="absolute left-0 transform lg:ml-2 top-1/2 translate-1/2"></div>
                  <img
                    className="object-contain w-full lg:h-full"
                    src={productDetailsById.imageSrc}
                    alt=""
                  />
                </div>
              </div>
              ...
              <div className="lg:pl-20">
                <div className="mb-6 ">
                  ...
                  <p className="inline-block text-2xl font-semibold text-gray-700 dark:text-gray-400 ">
                    <span>Rs. ${productDetailsById?.price}</span>
                    <span className="ml-3 text-base font-normal text-gray-500 line-through dark:text-gray-400">
                      Rs.{productDetailsById?.price + 200}
                    </span>
                  </p>
                </div>
                <div className="mb-6">
                  <h2 className="mb-2 text-lg font-bold text-gray-700 dark:text-gray-400">
                    System Specs : {productDetailsById.details}
                  </h2>
                ...
                <InputField product={productDetailsById} />
              </div>
            </div>
          </div>
        </div>
